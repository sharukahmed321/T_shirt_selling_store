...
const AdminDashBoard =() => {
    //destructuring the data from isAuthenticated() 
    //In user we will get name, email, role etc...
    ...
    return (
        <Base title="Welcome to Admin Privilege" description="Manage all of your products here" className="container bg-success p-4">
            <div className="row">
